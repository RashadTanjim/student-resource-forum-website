...
/*
	...
	Plugin Description: Facebook-like / Stackoverflow-like notifications on yourstudentrf forum that can replace all email-notifications.
	Plugin Version: → see qa-plugin.php
	Plugin Date: → see qa-plugin.php
	Plugin Author: q2apro.com
	Plugin Author URI: http://www.q2apro.com/
	Plugin License: GPLv3
	Plugin Minimumstudentrf Version: → see qa-plugin.php
